...
heart_image_path = os.path.join(assets_dir, 'Video_Game_Heart.png')
bronze_image_path = os.path.join(assets_dir, 'bronze_medal.png')
silver_image_path = os.path.join(assets_dir, 'silver_medal.png')
gold_image_path = os.path.join(assets_dir, 'gold_medal.png')
...
# Load heart image
# HEART_IMAGE = pygame.image.load('ASSETS/Video_Game_Heart.png')
